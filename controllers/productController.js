...
module.exports.apiCreateProductTokenPOST = function apiCreateProductTokenPOST(req, res, next) {
    ...
    Product.apiCreateProductTokenPOST(token, nameProduct, information, category, price, double, store, image_1, image_2, image_3, edit)
...
module.exports.apiGetProductTokenStartIdAmountGET = function apiGetProductTokenStartIdAmountGET(req, res, next) {
    var token = req.swagger.params['token'].value;
    ...
    Product.apiGetProductTokenStartIdAmountGET(token, startId, amount, word)
        .then(function (response) {
            utils.writeJson(res, response);
        })
        .catch(function (response) {
